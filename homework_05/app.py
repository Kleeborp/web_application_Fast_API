...
from routers.simple_reps import router as rep_router
from routers.main_handles import router as main_router


app = FastAPI()

app.include_router(rep_router, tags=["Обычные представления"], prefix="/api")
app.include_router(main_router, tags=["Автомобили"], prefix="/cars/premium")




if __name__ == "__main__":
    uvicorn.run('homework_05.app:app', host="127.0.0.1", port=8000, reload=True)